...
do
    ...
    python learn_generator.py --epochs 8 --batch 52 --train_gan --itera ${max_iter} --save_fig_num 5 --save_fig_folder data_${data_size}_pretrain_${pre_train_size} #  || play -n synth 1
